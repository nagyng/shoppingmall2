...
<div class="wrapper">
	<div class="wrap">
		...
		<div class="content_area">
						...
						<c:forEach items="${cartInfo}" var="ci">
							<tr>
								<td class="td_width_1 cart_info_td">
									...
									<input type="hidden" class="individual_caId_input" id="caId" name="caId" value="${ci.caId}">
			...
			<!-- 주문 form -->
			<form action="/order/order" method="get" class="order_form">
				<a class="order_btn" href='<sec:authentication property="principal.member.username"/>'>주문하기</a>
...
$(".quantity_modify_btn").on("click", function(){  
	...
	let caId = $(this).data("caid");			//data는 소문자로 바꿔야 작동한다
...
$(".order_btn").on("click", function(e){
	...
	//alert("form_contents: " + form_contents); 
	
	e.preventDefault(); 
	order_form.append("<input type='hidden' name='username' value='"+ $(this).attr("href") + "'>").html(form_contents);
	order_form.attr("action","/order/order");
	order_form.submit();
