				...
				<div class="panel-body">
					<form role="form" action="/event/register" method="post">
						...
						<div class="form-group">
							<label for="evTitle">공지 제목</label>
							<input type="text" id="evTitle" class="form-control" name="evTitle">
						</div>
						<div class="form-group">
							<label for="evContent">공지글</label>
							<textarea name="evContent" id="evContent" class="form-control" rows="5" cols="50"></textarea>
						</div>
						<div class="form-group">
