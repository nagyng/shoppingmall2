...
%>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">이벤트 공지사항</h1>
                </div> 
            </div> 
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover text-center" id="dataTables-example">
                                ...
                                <tr> 
                                	<td><c:out value="${event.evId }"/></td>
                                	<td> 
                                		<a class="move" href='<c:out value="${event.evId }"/>'>
                                			<c:out value="${event.evTitle }"/> 
                                		</a>
                                	</td>
                                	<td><c:out value="${event.username }"/></td>
                                	<td><fmt:formatDate pattern="yyyy-MM-dd" value="${event.evRegdate }"/></td>
                                	<td><fmt:formatDate pattern="yyyy-MM-dd" value="${event.evUpdateDate }"/></td>
                                </tr>
                                </c:forEach>
                            </table> 
                            
                            <form id="searchForm" action="/event/list" method="get"> 
                            	<select name="type">
                            ...
                            <form action="/event/list" method="get" id="actionForm">
...
$(document).ready(function() {
	...
	$(".move").on("click",function(e){
		...
		actionForm.append("<input type='hidden' name='evId' value='"+ $(this).attr("href") + "'>");
