...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">이벤트 공지 수정</h1>
	</div>
	<!-- /.col-lg-12 -->
</div>
<!-- /.row -->
...
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-heading">이벤트 공지 수정</div>
			<!-- /.panel-heading -->
			<div class="panel-body">
			<form role="form" action="/event/modify" method="post">
					...
					<div class="form-group">
						<label for="evId">evId</label>
						<input class="form-control" name="evId" id="evId" 
								value='<c:out value="${event.evId }" />' readonly="readonly">
					</div>
					
					<div class="form-group">
						<label for="evTitle">제목</label>
						<input class="form-control" name="evTitle" id="evTitle" value='<c:out value="${event.evTitle }" />' >
					</div>
					
					<div class="form-group">
						<label for="evContent">작성글</label>
						<textarea class="form-control" rows="5" name="evContent" id="evContent"><c:out value="${event.evContent }"></c:out></textarea>
					</div>
					 
					<div class="form-group">
						<label for="username">글쓴이</label>
						<input class="form-control" name="username" id="username" value='<c:out value="${event.username }" />' readonly>
					</div> 
...
$(document).ready(function() {
	...
	$('button').on("click", function(e){
		...
		if(operation === 'remove'){		//삭제 버튼 클릭 처리 
			...
			//return;  
			formObj.attr("action", "/event/list").attr("method","get"); 
			//p321 	3/21
